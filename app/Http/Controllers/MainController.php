...
class MainController extends Controller
{
    ...
    {
        Mail::to(env('MAIL_TO_ADDRESS', 'support@poowflabs.com'))->send(
            new ContactForm($request->input('name'), $request->input('email'), $request->input('message')),
        );
