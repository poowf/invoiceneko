...
<div class="invoice" style="background-color: #ffffff; padding: 50px 50px 20px; color: #8c8c8c;">
    <div class="row invoice-header" style="position: relative; margin-bottom: 120px;">
        ...
        <div class="col-xs-5 invoice-order" style="position: absolute; right: 0; padding: 0 15px; text-align: right;">
            <span class="invoice-id" style="display: block; font-size: 30px; line-height: 30px;">Invoice #2308</span>
            <span class="incoice-date" style="display: block; font-size: 18px; line-height: 30px;">August 23, 2016</span>
        </div>
    </div>
    <div class="row invoice-data" style="position: relative; margin-bottom: 280px;">
        <div class="col-xs-5 invoice-person" style="position: absolute; left: 0; padding: 0 15px; ">
            <span class="name" style="font-size: 18px; line-height: 26px; display: block; font-weight: 700;">Kristopher Donny</span>
        ...
        <div class="col-xs-2 invoice-payment-direction" style="position: absolute; padding-top: 20px; left: 0; right:0; text-align: center;">
            <img src="{{ asset('/assets/img/lefttoright.png') }}" width="80" height="80" />
        </div>
        <div class="col-xs-5 invoice-person" style="position: absolute; right: 0; padding: 0 15px; text-align: right;">
            <span class="name" style="font-size: 18px; line-height: 26px; display: block; font-weight: 700;">Elliot Mark</span>
            <span style="font-size: 18px; line-height: 26px; display: block;">CEO at BLX</span>
            <span style="font-size: 18px; line-height: 26px; display: block;">ceoblx@company.co</span>
            <span style="font-size: 18px; line-height: 26px; display: block;">839 Owagner Drive</span>
            <span style="font-size: 18px; line-height: 26px; display: block;">United States</span>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row invoice-footer" style="text-align: center;">
        <div class="col-md-12" style="position: relative; padding: 0 15px;">
            <button class="btn btn-lg btn-space btn-default" style="-webkit-box-shadow: 0 1px 0 rgba(0, 0, 0, 0.05); box-shadow: 0 1px 0 rgba(0, 0, 0, 0.05); border: 1px solid transparent; color: #404040; background-color: #fff; border-color: #dedede; padding: 0 12px; line-height: 38px; border-radius: 3px; font-weight: 700; margin-right: 5px; margin-bottom: 5px; min-width: 96px; font-size: 14px;">
                Save PDF
            </button>
            <button class="btn btn-lg btn-space btn-default" style="-webkit-box-shadow: 0 1px 0 rgba(0, 0, 0, 0.05); box-shadow: 0 1px 0 rgba(0, 0, 0, 0.05); border: 1px solid transparent; color: #404040; background-color: #fff; border-color: #dedede; padding: 0 12px; line-height: 38px; border-radius: 3px; font-weight: 700; margin-right: 5px; margin-bottom: 5px; min-width: 96px; font-size: 14px;">
                Print
            </button>
            <button class="btn btn-lg btn-space btn-primary" style="-webkit-box-shadow: 0 1px 0 rgba(0, 0, 0, 0.05); box-shadow: 0 1px 0 rgba(0, 0, 0, 0.05); border: 1px solid transparent; color: #fff; background-color: #4da6a6; border-color: #4da6a6; padding: 0 12px; line-height: 38px; border-radius: 3px; font-weight: 700; margin-right: 5px; margin-bottom: 5px; min-width: 96px; font-size: 14px;">
                Pay now
            </button>
        </div>
    </div>
