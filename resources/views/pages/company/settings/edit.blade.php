                    ...
                    <div class="card-panel">
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="tax" name="tax" type="number" data-parsley-trigger="change" value="{{ $companysettings->tax ?? '' }}" placeholder="Company Tax %"  @if(!$company) disabled @endif>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="invoice_prefix" name="invoice_prefix" type="text" data-parsley-trigger="change" data-parsley-minlength="2" value="{{ $companysettings->invoice_prefix ?? '' }}" placeholder="Invoice Prefix" @if(!$company) disabled @endif>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="quote_prefix" name="quote_prefix" type="text" data-parsley-trigger="change" data-parsley-minlength="2" value="{{ $companysettings->quote_prefix ?? '' }}" placeholder="Quote Prefix" @if(!$company) disabled @endif>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea id="quote_conditions" name="quote_conditions" class="trumbowyg-textarea" data-parsley-required="true" data-parsley-trigger="change" placeholder="Quote Conditions" @if(!$company) disabled @endif>@if(isset($companysettings->quote_conditions)){!! $companysettings->quote_conditions !!}@else @endif</textarea>
