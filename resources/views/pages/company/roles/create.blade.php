                            ...
                            @for($i = 0; $i < $permissions->count(); $i++)
                                ...
                                <div class="input-field col s6 m3">
                                    ...
                                    <div class="switch mtop20">
                                        <label>
                                            <input id="permissions-{{ $permissions[$i]->name }}" name="permissions[]" data-permission-type="{{ str_slug(strtolower($permissions[$i]->type)) }}" type="checkbox" value="{{ $permissions[$i]->name }}">
                                            <span class="lever"></span>
                                            Allow
                                        </label>
                                    </div>
