                    ...
                    <div id="quote-items-container">
                        @foreach($quote->items as $key => $item)
                            <div id="quote_item_{{ $key }}" class="card-panel">
                                ...
                                <div class="row">
                                    <button data-id="{{ $item->id }}"  data-count="{{ $key }}" class="quote-item-delete-btn btn waves-effect waves-light col s12 m2 offset-m10 red">Delete</button>
                                </div>
                            </div>
                        @endforeach
                    </div>
