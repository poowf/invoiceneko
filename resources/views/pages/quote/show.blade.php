                ...
                <div class="quote" style="background-color: #ffffff; padding: 50px 50px 20px; color: #8c8c8c;">
                    <div class="row quote-header" style="position: relative; margin-bottom: 160px;">
                        ...
                        <div class="col-xs-5 quote-order" style="position: absolute; right: 0; padding: 0 15px; text-align: left;">
                            ...
                            <span class="quote-date" style="display: block; font-size: 18px; line-height: 30px; text-align: right;">Quote Date: {{ $quote->date->format('d F, Y') }}</span>
                            <span class="quote-duedate" style="display: block; font-size: 18px; line-height: 30px; text-align: right;">Quote Expires: {{ $quote->duedate->format('d F, Y') }}</span>
                        </div>
                    </div>
