@extends("layouts.default", ['page_title' => 'Recipient | Create'])
...
@section("content")
    <div class="container">
        ...
        <div class="row">
            <div class="col s12">
                <form id="create-recipient" method="post" enctype="multipart/form-data">
                    <div class="card-panel">
                        <div class="row">
                            <div class="input-field col s12">
                                <select id="salutation" name="salutation" data-parsley-required="true" data-parsley-trigger="change">
                                    ...
                                    <option value="mdm" @if(old('salutation') == "mdm") selected @endif>Mdm.</option>
                                    <option value="miss" @if(old('salutation') == "miss") selected @endif>Miss.</option>
                                    <option value="dr" @if(old('salutation') == "dr") selected @endif>Dr.</option>
                                    <option value="prof" @if(old('salutation') == "prof") selected @endif>Prof.</option>
                                    <option value="mx" @if(old('salutation') == "mx") selected @endif>Mx.</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="first_name" name="first_name" type="text" data-parsley-required="true" data-parsley-trigger="change" value="{{ old('first_name') }}" placeholder="Recipient First Name">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="last_name" name="last_name" type="text" data-parsley-trigger="change" value="{{ old('last_name') }}" placeholder="Recipient Last Name">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="email" name="email" type="email" data-parsley-required="true" data-parsley-trigger="change" value="{{ old('email') }}" placeholder="Recipient Email">
...
@section("scripts")
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            Unicorn.initParsleyValidation('#create-recipient');
        });
    </script>
@stop