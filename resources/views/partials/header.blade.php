                ...
                <div class="row">
                    <div class="col l12 no-padding">
                        <div class="nav-wrapper">
                            ...
                            <a href="{{ route('main') }}" class="logo black-text"><img src="{{ asset('assets/img/logo.svg') }}" height="60"><span class="logo-text">{{ config('app.name') }}</span></a>
                                ...
                                @if(Auth::check())
                                    ...
                                    <ul id="dropdown-navigation" class="dropdown-content" style="margin-left: 15px;">
                                        @if(app('request')->route('company'))
                                            ...
                                            <li><a href="{{ route('user.edit', [ 'company' => \App\Library\Poowf\Unicorn::getCompanyKey() ]) }}">Profile</a></li>
