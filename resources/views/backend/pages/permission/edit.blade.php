        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-default panel-border-color panel-border-color-primary">
                    <div class="panel-heading panel-heading-divider">Fill up the form below to change a Permission<span
                            ...
                            <div class="form-group xs-mt-10">
                                ...
                                <div class="col-sm-10">
                                    <input id="name" name="name" type="text" placeholder="Enter name"
                                           value="{{ $permission->name }}" class="form-control" data-parsley-required
                            ...
                            <div class="form-group xs-mt-10">
                                ...
                                <div class="col-sm-10">
                                    <input id="label" name="label" type="text" placeholder="Enter label"
                                           value="{{ $permission->label }}" class="form-control" data-parsley-required
                                           data-parsley-trigger="change">
                                </div>
                            </div>
